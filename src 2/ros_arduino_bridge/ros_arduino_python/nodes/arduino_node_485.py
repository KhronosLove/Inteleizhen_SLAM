...
"""
    ...
    Copyright (c) 2012 Patrick Goebel.  All rights reservd = "010345010001"ed.
...
"""
#import sys
#sys.path.append("/home/oem/catkin1_ws/src/ros_arduino_bridge/ros_arduino_python/src/")
def test():
    controller = Arduino485("/dev/Serial0", 19200, 0.5, False)
...
import rospy
from ros_arduino_python.arduino_driver_485 import Arduino485
#test()
from ros_arduino_python.arduino_sensors import *
from ros_arduino_msgs.srv import *
from ros_arduino_python.base_controller_new import BaseController
...
class ArduinoROS():
    def __init__(self):
        rospy.init_node('arduino',anonymous=True, log_level=rospy.INFO)
        ...
        self.controller = Arduino485(self.port, self.baud, self.timeout, self.motors_reversed)
        ...
        #seri = serial.Serial(self.port,self.baud,timeout=self.timeout)
