  ...
  while (n.ok())
  {
	  ...
	  if(model == "100S" && data_raw[kk] == 0xA5 && data_raw[kk + 1] == 0x5A)
          ...
          if(model == "100D2" && data_raw[kk] == 0xA5 && data_raw[kk + 1] == 0x5A)
          {
              ...
              //msg.orientation.x = (double)q.y();
              //msg.orientation.y = -(double)q.x();
              ...
              //msg.linear_acceleration.x = d2f_acc(data + 11) * 9.81;
              //msg.linear_acceleration.y = -d2f_acc(data + 9) * 9.81;
              ...
              //msg_mag.magnetic_field.x = d2f_mag(data + 23);
              //msg_mag.magnetic_field.y = -d2f_mag(data + 21);
